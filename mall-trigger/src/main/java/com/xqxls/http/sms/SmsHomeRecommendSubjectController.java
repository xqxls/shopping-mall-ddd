...
public class SmsHomeRecommendSubjectController {
    ...
    @ResponseBody
    public CommonResult<Object> create(@RequestBody List<SmsHomeRecommendSubjectVO> homeBrandList) {
    ...
    @ResponseBody
    public CommonResult<CommonPage<SmsHomeRecommendSubjectVO>> list(@RequestParam(value = "subjectName", required = false) String subjectName,
                                                                  @RequestParam(value = "recommendStatus", required = false) Integer recommendStatus,
                                                                  @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                                                  @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        List<SmsHomeRecommendSubjectVO> homeBrandList = recommendSubjectService.list(subjectName, recommendStatus, pageSize, pageNum);
